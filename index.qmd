...
::: {.column width="25%"}
<div data-bs-toggle="modal" data-bs-target="#modalYears" style="cursor:pointer;">
# 15+
Years of Service
</div>
:::
...
::: {.column width="25%"}
<div data-bs-toggle="modal" data-bs-target="#modalLives" style="cursor:pointer;">
# 5,000+
Lives Reached
</div>
:::
...
::: {.column width="25%"}
<div data-bs-toggle="modal" data-bs-target="#modalCommunities" style="cursor:pointer;">
# 25+
Communities
</div>
:::
...
::: {.column width="25%"}
<div data-bs-toggle="modal" data-bs-target="#modalSupport" style="cursor:pointer;">
# ₦50M+
Community Support
</div>
:::
...
::: {.column width="33%"}
::: {.card-custom}
<div data-bs-toggle="modal" data-bs-target="#modalEducation" style="cursor:pointer;">
# 🎓
### Education & Youth
...
::: {.column width="33%"}
::: {.card-custom}
<div data-bs-toggle="modal" data-bs-target="#modalHealthcare" style="cursor:pointer;">
# 🏥
...
::: {.column width="33%"}
::: {.card-custom}
<div data-bs-toggle="modal" data-bs-target="#modalLeadership" style="cursor:pointer;">
# 🤝
...
```{=html}
<div class="modal fade" id="modalYears" tabindex="-1">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title">15+ Years of Service</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
      </div>
      <div class="modal-body">
        <img src="images/founder.jpg.jpeg" style="width:100%; border-radius:10px; margin-bottom:1rem;">
...
<div class="modal fade" id="modalLives" tabindex="-1">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title">5,000+ Lives Reached</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
      </div>
      <div class="modal-body">
        <img src="images/founder.jpg.jpeg" style="width:100%; border-radius:10px; margin-bottom:1rem;">
...
<div class="modal fade" id="modalCommunities" tabindex="-1">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title">25+ Communities</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
      </div>
      <div class="modal-body">
        <img src="images/founder.jpg.jpeg" style="width:100%; border-radius:10px; margin-bottom:1rem;">
...
<div class="modal fade" id="modalSupport" tabindex="-1">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title">₦50M+ Community Support</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
      </div>
      <div class="modal-body">
        <img src="images/founder.jpg.jpeg" style="width:100%; border-radius:10px; margin-bottom:1rem;">
...
<div class="modal fade" id="modalEducation" tabindex="-1">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title">Education & Youth</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
      </div>
      <div class="modal-body">
        <img src="images/founder.jpg.jpeg" style="width:100%; border-radius:10px; margin-bottom:1rem;">
...
<div class="modal fade" id="modalHealthcare" tabindex="-1">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title">Healthcare & Development</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
      </div>
      <div class="modal-body">
        <img src="images/founder.jpg.jpeg" style="width:100%; border-radius:10px; margin-bottom:1rem;">
...
<div class="modal fade" id="modalLeadership" tabindex="-1">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title">Transparent Leadership</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
      </div>
      <div class="modal-body">
        <img src="images/founder.jpg.jpeg" style="width:100%; border-radius:10px; margin-bottom:1rem;">
